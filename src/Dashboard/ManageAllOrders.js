...
const ManageAllOrders = () => {
  ...
  useEffect(() => {
    fetch("https://carhub-server.onrender.com/allorder")
      .then((res) => res.json())
  ...
  const handleShipped = (id) => {
    console.log(id);
    fetch(`https://carhub-server.onrender.com/allorder/${id}`, {
      method: "PATCH",
      headers: {
  ...
  const handleDelete = (id) => {
    console.log(id);
    fetch(`https://carhub-server.onrender.com/order-parts/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
