...
const Footer = () => {
    return (
        <div className='mt-5'>
            <footer class="footer lg:place-items-center place-items-start p-10 bg-base-100 text-base-content lg:grid-cols-3 grid-cols-2">
                <div className=''>
            ...
            <footer class="footer px-10 py-4 border-t bg-base-100 text-base-content border-base-300 ">
                <div class="lg:items-center grid-flow-col lg:block hidden">
                    ...
                    <p>Car<span className='text-secondary'>Hub</span> Ltd. <br />Providing reliable parts since 1992</p>
                </div>
                <div class="md:place-self-center md:justify-self-end place-self-center">
